...
const Create = () => {
    ...
    // console.log(form?.ideo?.file?.name);
    ...
    return (
        <SafeAreaView className='bg-primary h-full'>
            <ScrollView className='px-4 my-6'>
                ...
                <FormFlied title='Video Title'
                    value={form.title}
                    placeholder='Given your video a catch title'
                ...
                <View className='mt-7 space-y-2'>
                    ...
                    >
                        {form.video ? (<Video source={{ uri: form.video.uri }} resizeMode={ResizeMode.COVER}
                            useNativeControls
                            isLooping
                ...
                <FormFlied title='AI Prompt'
                    value={form.title}
                    placeholder='The prompt use to create this video'
                    handleChangeText={(e) => setForm({
                        ...form, prompt: e
                    })}
                    otherStyle='mt-7'
